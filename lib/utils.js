...
const isHtmlContentType = content_type => Boolean((content_type || "").match(/(html)/gi));

module.exports = { httpRequest, parseJSON, getContentType, isImageContentType, isHtmlContentType };
